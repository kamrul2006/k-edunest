            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 px-6 gap-10 items-center">
                ...
                <Slide direction="left" triggerOnce>
                    <div className="space-y-6">
                        <p className="text-sm uppercase tracking-wide text-pink-300 font-semibold">
                            About K-Edunest
                        </p>
                        <h2 className="text-4xl lg:text-5xl font-bold leading-snug text-white">
                            Empowering Learners, Inspiring Futures
                        </h2>
                        <p className="text-pink-100 text-justify leading-relaxed">
                ...
                <Slide direction="right" triggerOnce>
                    <div className="space-y-6">
                        <p className="text-lg text-pink-100 text-justify leading-relaxed px-2 lg:px-0">
                        ...
                        <div className="flex items-center gap-4 border border-pink-400 bg-white/10 backdrop-blur-md px-6 py-4 rounded-3xl w-fit">
                            <Image
                                src="/pp.jpg"
                            ...
                            <div>
                                ...
                                <p className="text-sm text-pink-200">Founder and CEO, K-Edunest</p>
                            </div>
                        </div>
                    </div>
                </Slide>
